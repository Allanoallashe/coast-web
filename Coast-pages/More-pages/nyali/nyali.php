...
<body>
  ...
  <header class="head">
    <div class="nav">
      <ol>
        <a href="./nyali.php">
        <i class="fa-solid fa-otter fa-spin fa-spin-reverse"></i> Nyali</a>
     </ol>
      <main class="active">
        <a><i id="pope" class="fa-solid fa-bars"></i></a>
      </main>
      <ul>
        <li><a href="./nyali.php"><i class="fa-solid fa-otter fa-spin fa-spin-reverse"></i> Nyali</a></li>
        ...
        <li id="list"><a id="drop"><i class="fa fa-caret-down"></i> More</a>
         <div id="more">
          <ul id="browse1">
            ...
            <li class="item4"><a href="../Mombasa/mombasa.php">Mombasa</a></li>
  ...
  <div id="display">
       ...
       <li><a href="#" class="swipe1">Images</a></li>
     ...
     <div class="more1" id="more1">
          <ul id="browse-two">
            ...
            <li id="nero1"><a href="../lamu/lamu.php">Lamu</a></li>
            <li id="nero2"><a href="../kilifi/kilifi.php">Kilifi</a></li>
            <li id="nero3"><a href="../diani/diani.php">Diani</a></li>
            <li id="nero4"><a href="../malindi/malindi.php">Malindi</a></li>
     ...
     <!-- marque -->
  <div class='marque'>
    <marquee width="98%"  direction="left" height="100%" behavior="scroll" scrollamount="5" loop="100000">The coastal regions i.e. the coast of Kenya, are very nice places to visit especially during the holidays. The beaches have very nice aesthetic beauty. Register to get started and book your hotels prier🥳.Accomodations are there in plenty&#128150;  &#128519;. Welcome to the Coast of Kenya🥳</marquee>
  </div>
  ...
  <!-- coasts -->
   <p class="title">Nyali Images &plus;</p>
  <div class="main">

    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N1.jpg" alt="Theme">
      </div>
    </div>

    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N10.jpg" alt="Theme">
      </div>
    </div>

    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N11.jpg" alt="Theme">
      </div>
    </div>

    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N12.jpg" alt="Theme">
      </div>
    </div>

    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N13.jpg" alt="Theme">
      </div>
    </div>

    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N14.jpg" alt="Theme">
      </div>
    </div>

    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N15.jpg" alt="Theme">
      </div>
    </div>

    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N16.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N17.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N18.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N19.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N20.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N21.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N22.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N3.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N5.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N6.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N7.jpg" alt="Theme">
      </div>
    </div>
    <div class="img-container">
      <div class="images">
        <img src="./images/coast/N8.jpg" alt="Theme">
      </div>
    </div>
    <div id='title' class="img-container">
      <div class="images">
        <img src="./images/coast/N9.jpg" alt="Theme">
      </div>
    </div>
  ...
  <!-- hotels -->
     <p id="title1" class="title1">Nyali Restaurants &plus;</p>
   <div class="main">
    <div class="img-container">
      <div class="images">
  ...
  <iframe in="mapi" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15919.519356398821!2d39.68667910045557!3d-4.0449324510297915!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1840124387dc69b9%3A0x38f0f0a7cf299e0b!2sNyali%20Beach!5e0!3m2!1sen!2ske!4v1681296150094!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>
...
<!-- footer -->
   <footer class="bottom">
      ...
      <p class="website__rights">
              <span class="dot"><strong>C</strong></span> 
              <span class="text">@allashe.com 2023. All rights reserved.</span>
      </p>
